...
/** Global search list filtered with user's location (via geo-localization)
 *
 * @since 10.2.0
 */
SC_PUBLISHED extern const struct SC_ScoresSearchList_tag SC_SCORES_SEARCH_LIST_LOCAL_COUNTRY;
 ...
 * @deprecated 10.2.0
 */
SC_DEPRECATED SC_PUBLISHED extern const struct SC_ScoresSearchList_tag SC_SCORES_SEARCH_LIST_USER_COUNTRY;
