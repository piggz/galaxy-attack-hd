...
/**
 * @brief Returns the terms of service state.
 * 
 * This method returns the state of the TOS.
 *
 * @param self An opaque handle for the current session instance.
 * @return SC_TermsOfServiceState_t the state of the terms of service
 */
SC_PUBLISHED SC_TermsOfServiceState_t SC_Session_GetTermsOfServiceState(SC_Session_h self);
