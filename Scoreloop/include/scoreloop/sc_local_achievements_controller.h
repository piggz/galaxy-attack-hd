 ...
 *
 * @param   self        SC_LocalAchievementsController instance handle
 * @return SC_Error_t   A return code (A value of SC_OK indicates success, any other value indicates an error. @if Blackberry10only For more error codes see @link page-synchronise here@endlink).@endif
 *
 * @since 10.0.0
 */
 ...
 * @return SC_Error_t           A return code (A value of SC_OK indicates success, any other value indicates an error. @if Blackberry10only For more error codes see @link page-SetValueForAwardIdentifier here@endlink).@endif
 *
 * @since 10.0.0
 */
