 ...
 * @deprecated 10.2.0
 */
SC_DEPRECATED SC_PUBLISHED SC_Error_t SC_User_SetNationality(SC_User_h self, const char *nationality);
 ...
 * @deprecated 10.2.0
 */
SC_DEPRECATED SC_PUBLISHED SC_String_h SC_User_GetNationality(SC_User_h self);
