 ...
 *
 * Developers must register their games on https://developer.scoreloop.com in order to obtain an identifier and retret for the game application. In addition
...
#include <scoreloop/sc_terms_of_service_controller.h>
 ...
 * @return SC_Error_t A return code (A value of SC_OK indicates success, any other value indicates an error. @if Blackberry10only For more error codes see @link page-New here@endlink).@endif
 *
 * @since 10.0.0
 */
 ...
 */
SC_PUBLISHED SC_Error_t SC_Client_NewWithConfig(SC_Client_h* pSelf, SC_ClientConfig_h clientConfig);
 ...
 * @return SC_Error_t A return code (A value of SC_OK indicates success, any other value indicates an error. @if Blackberry10only For more error codes see @link page-CreateScoresController here@endlink).@endif
 *
 * @since 10.0.0
 */
 ...
 * @param cookie This will be passed back to the controller's callback and using this, users
 * can use the same callback for multiple controllers if they wish to.
 * @return SC_Error_t A return code (A value of SC_OK indicates success, any other value indicates an error. @if Blackberry10only For more error codes see @link page-CreateScoreController here@endlink).@endif
 *
 * @since 10.0.0
 */
 ...
 * @param cookie This will be passed back to the controller's callback and using this, users
 * can use the same callback for multiple controllers if they wish to.
 * @return SC_Error_t A return code (A value of SC_OK indicates success, any other value indicates an error. @if Blackberry10only For more error codes see @link page-CreateRankingController here@endlink).@endif
 *
 * @since 10.0.0
 */
 ...
 * @param cookie This will be passed back to the controller's callback and using this, users
 * can use the same callback for multiple controllers if they wish to.
 * @return SC_Error_t A return code (A value of SC_OK indicates success, any other value indicates an error. @if Blackberry10only For more error codes see @link page-CreateMessageController here@endlink).@endif
 *
 * @since 10.0.0
 */
 ...
 * @param cookie This will be passed back to the controller's callback and using this, users
 * can use the same callback for multiple controllers if they wish to.
 * @return SC_Error_t A return code (A value of SC_OK indicates success, any other value indicates an error. @if Blackberry10only For more error codes see @link page-CreateChallengeController here@endlink).@endif
 *
 * @since 10.0.0
 */
 ...
 * @param cookie This will be passed back to the controller's callback and using this, users
 * can use the same callback for multiple controllers if they wish to.
 * @return SC_Error_t A return code (A value of SC_OK indicates success, any other value indicates an error. @if Blackberry10only For more error codes see @link page-CreateChallengesController here@endlink).@endif
 *
 * @since 10.0.0
 */
 ...
 * @param cookie This will be passed back to the controller's callback and using this, users
 * can use the same callback for multiple controllers if they wish to.
 * @return SC_Error_t A return code (A value of SC_OK indicates success, any other value indicates an error. @if Blackberry10only For more error codes see @link page-CreateUserController here@endlink).@endif
 *
 * @since 10.0.0
 */
 ...
 * @param cookie This will be passed back to the controller's callback and using this, users
 * can use the same callback for multiple controllers if they wish to.
 * @return SC_Error_t A return code (A value of SC_OK indicates success, any other value indicates an error. @if Blackberry10only For more error codes see @link page-CreateUsersController here@endlink).@endif
 *
 * @since 10.0.0
 */
 ...
 * @param cookie This will be passed back to the controller's callback and using this, users
 * can use the same callback for multiple controllers if they wish to.
 * @return SC_Error_t A return code (A value of SC_OK indicates success, any other value indicates an error. @if Blackberry10only For more error codes see @link page-CreateLocalAchievementsController here@endlink).@endif
 *
 * @since 10.0.0
 */
 ...
 * @param cookie This will be passed back to the controller's callback and using this, users
 * can use the same callback for multiple controllers if they wish to.
 * @return SC_Error_t A return code (A value of SC_OK indicates success, any other value indicates an error. @if Blackberry10only For more error codes see @link page-CreateAchievementsController here@endlink).@endif
 *
 * @since 10.0.0
 */
 ...
 * @param cookie This will be passed back to the controller's callback and using this, users
 * can use the same callback for multiple controllers if they wish to.
 * @return SC_Error_t A return code (A value of SC_OK indicates success, any other value indicates an error. @if Blackberry10only For more error codes see @link page-CreateActivitiesController here@endlink).@endif
 *
 * @since 10.0.0
 */
 ...
 * @param cookie This will be passed back to the controller's callback and using this, users
 * can use the same callback for multiple controllers if they wish to.
 * @return SC_Error_t A return code (A value of SC_OK indicates success, any other value indicates an error. @if Blackberry10only For more error codes see @link page-CreateGamesController here@endlink).@endif
 *
 * @since 10.0.0
 */
 ...
 * @param cookie This will be passed back to the controller's callback and using this, users
 * can use the same callback for multiple controllers if they wish to.
 * @return SC_Error_t A return code (A value of SC_OK indicates success, any other value indicates an error. @if Blackberry10only For more error codes see @link page-CreateGameItemController here@endlink).@endif
 *
 * @since 10.0.0
 */
 ...
 * @param cookie This will be passed back to the controller's callback and using this, users
 * can use the same callback for multiple controllers if they wish to.
 * @return SC_Error_t A return code (A value of SC_OK indicates success, any other value indicates an error. @if Blackberry10only For more error codes see @link page-CreateGameItemsController here@endlink).@endif
 *
 * @since 10.0.0
 */
...
/**
 * @brief Creates an instance of SC_TermsOfServiceController
 *
 * Method to create a TermsOfServiceController object.
 *
 * @param self Opaque handle for the current client instance.
 * @param pTosController Opaque handle for the controller that will be created.
 * @param callback Handle to be registered for callback.
 * @param cookie This will be passed back to the controller's callback and using this, users
 * can use the same callback for multiple controllers if they wish to.
 * @return SC_Error_t A return code (A value of SC_OK indicates success, any other value indicates an error. @if Blackberry10only For more error codes see @link page-CreateGameItemsController here@endlink)@endif.
 */
SC_PUBLISHED SC_Error_t SC_Client_CreateTermsOfServiceController(SC_Client_h self,
        SC_TermsOfServiceController_h* pTosController,
        SC_RequestControllerCompletionCallback_t callback, void* cookie);
