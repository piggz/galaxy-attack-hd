...
#include <scoreloop/scui_platform.h>
 ...
 */
SC_DEPRECATED SC_PUBLISHED SC_Error_t SCUI_Client_New(SCUI_Client_h* pSelf, SC_Client_h client);
 ...
 */
SC_DEPRECATED SC_PUBLISHED SC_Error_t SCUI_Client_ShowFavoriteGamesView(SCUI_Client_h self, SCUI_ViewResultCallback_t callback, void *cookie);
