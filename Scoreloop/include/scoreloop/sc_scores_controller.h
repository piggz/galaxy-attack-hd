 ...
 * @return SC_Error_t A return code (a value of SC_OK indicates success, any other value indicates an error. @if Blackberry10only For more error codes see @link page-SetSearchList here@endlink).@endif
 */
 ...
 * @return SC_Error_t A return code (A value of SC_OK indicates success, any other value indicates an error. @if Blackberry10only For more error codes see @link page-SetMode here@endlink).@endif
 */
 ...
 * @return SC_Error_t A return code (a value of SC_OK indicates success, any other value indicates an error. @if Blackberry10only For more error codes see @link page-LoadScoresAtRank here@endlink).@endif
 */
