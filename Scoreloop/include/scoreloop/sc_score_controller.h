 ...
 * @return SC_Error_t A return code (a value of SC_OK indicates success, any other value indicates an error. @if Blackberry10only For more error codes see @link page-SubmitScore here@endlink).@endif
 *
 * @since 10.0.0
 */
